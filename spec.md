...
**ValoHub** (рабочее название) — это специализированная социальная экосистема для игроков в Valorant.
Платформа объединяет функции социальной сети, автоматизированной турнирной площадки и инструментов для поиска коммьюнити в едином пространстве.

**Ключевая идея:** Игроки находят тиммейтов, объединяются в команды, участвуют в честных соревнованиях и следят за новостями игры — всё в одном месте.

### 1.1. Принципы продукта
1.  **Честность и прозрачность:** Привязка Riot ID как основа идентификации. Минимум «подстав», максимум проверяемых действий.
2.  **Понятные роли:** Четкое разделение ответственности (Капитан/Тренер управляют командой, Организатор — турниром).
3.  **Одинаковый интерфейс:** Web и Desktop выглядят идентично. Разница — в возможностях автоматизации.
4.  **Масштабируемость:** Архитектура закладывается под мультигейминг в будущем.

### 1.2. Платформы
У продукта две «оболочки» с общим UI:
* **Web (Публичный доступ):** Быстрый доступ к профилю, сеткам, просмотру матчей и регистрации. Работает с любого устройства.
* **Desktop (Основная версия):** Electron-клиент. Расширенные функции автоматизации, локальная интеграция с клиентом Valorant, работа с лобби и ускорение турнирных действий.
