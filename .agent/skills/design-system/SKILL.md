---
name: design-system
description: ValoHub "Digital Couture" design system guidelines. Use when creating UI components, styling elements, choosing colors, typography, or applying visual effects. Ensures consistent premium cyber-sport aesthetic across the platform.
metadata:
  author: valohub-team
  version: "1.0"
---
...
**"Is this premium?" Test** — Before committing, ask:
