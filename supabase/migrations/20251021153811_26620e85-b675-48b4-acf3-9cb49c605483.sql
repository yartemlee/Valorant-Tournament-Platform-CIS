-- Rename and change team_name column to team_id with proper type
ALTER TABLE tournament_participants 
  ALTER COLUMN team_name TYPE UUID USING team_name::UUID;

ALTER TABLE tournament_participants 
  RENAME COLUMN team_name TO team_id;
...
-- Update rpc_fill_tournament function to use team_id
...
BEGIN
  ...
  FOR i IN 1..teams_needed LOOP
    ...
    -- Register team to tournament using team_id instead of team_name
